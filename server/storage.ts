...
export class MemStorage implements IStorage {
  ...
  private seed() {
    ...
    this.salesInvoices.set("si1", {
      ...
      customerId: null,
      project: "Khadava- Plot 14",
      amountIncGst: "2377747.00",
      duePayment: "1038158.00",
      invoiceNo: "IES/26-27/09",
      invoiceDate: "2026-05-09",
      financialYear: "2026-2027",
      taxableAmount: "879794.92",
      totalGst: "158363.08",
      invoiceTotal: "1038158.00",
      cgstAmount: "0.00",
      sgstAmount: "0.00",
      igstAmount: "158363.08",
      supplyType: "Interstate",
      irnNumber: "IRN-IES-2627-009",
      isEInvoice: true,
      status: "pending",
      lineItems: [
        { item: "Hot Dip Galvanised Cable Trays 300x100x1.6mm", qty: 250, unit: "Mtr", hsn: "73089090", rate: "3519.18", discount: 0, taxableValue: 879794.92, cgstRate: 0, cgstAmount: 0, sgstRate: 0, sgstAmount: 0, igstRate: 18, igstAmount: 158363.08, total: 1038158.00, batchNo: "B-9834", serialNo: "SN-023", weight: 920, warehouse: "Kolkata Works W1", project: "Project Ezra", costCenter: "IES-SALES" }
      ],
      rawData: {
        buyer: {
          name: "L&T Construction",
          gstin: "27AAACL8391N2Z1",
    ...
    this.salesInvoices.set("si2", {
      ...
      amountIncGst: "-11623000.00",
      duePayment: "0.00",
      invoiceNo: "IES/25-26/119",
      invoiceDate: "2026-03-31",
      financialYear: "2025-2026",
      taxableAmount: "615000.00",
      totalGst: "110700.00",
      invoiceTotal: "725700.00",
      cgstAmount: "0.00",
      sgstAmount: "0.00",
      igstAmount: "110700.00",
      supplyType: "Interstate",
      irnNumber: "IRN-IES-2526-119",
      isEInvoice: true,
      status: "processed",
      lineItems: [
        { item: "Hot Dip Galvanised Perforated Cable Trays 50x50x1.6mm", qty: 320, unit: "Mtr", hsn: "73089090", rate: "1921.87", discount: 0, taxableValue: 615000.00, cgstRate: 0, cgstAmount: 0, sgstRate: 0, sgstAmount: 0, igstRate: 18, igstAmount: 110700.00, total: 725700.00, batchNo: "B-9835", serialNo: "SN-024", weight: 800, warehouse: "Howrah Works W2", project: "IOCL Project", costCenter: "IES-SALES" }
      ],
      rawData: {
        buyer: {
          name: "B&R Vadodara",
          gstin: "24AAACB9824F1ZA",
          address: "GIDC Industrial Estate, Vadodara, Gujarat - 390016",
          state: "Gujarat",
          state_code: "24"
        }
      },
      ...
      branchLocation: "Howrah Works W2",
      pendingDays: 0,
      tcsCollected: "12915.00", // 2.1% TCS of basic
      instRxilCharges: "0.00",
      amountInBank: "712785.00",
      balance: "12915.00",
      dateAsOn: "",
      balanceShortage: "0.00",
      orderStatus: "CLOSED",
      disputeReason: null,
      createdAt: new Date()
    });

    this.salesInvoices.set("si3", {
      id: "si3",
      slNo: "42/25-26",
      poNumber: "MO/71139/IOCL/CableTray/PO/194 Dated 25.03.2026",
      customerName: "B&R Vadodara",
      ...
      project: "IOCL Vadodara",
      amountIncGst: "-11623000.00",
      duePayment: "708708.00",
      invoiceNo: "IES/26-27/07",
      invoiceDate: "2026-04-28",
      financialYear: "2026-2027",
      taxableAmount: "600600.00",
      totalGst: "108108.00",
      invoiceTotal: "708708.00",
      cgstAmount: "0.00",
      sgstAmount: "0.00",
      igstAmount: "108108.00",
      supplyType: "Interstate",
      irnNumber: "IRN-IES-2627-007",
      isEInvoice: true,
      status: "pending",
      lineItems: [
        { item: "Hot Dip Galvanised Perforated Cable Trays 50x50x1.6mm", qty: 310, unit: "Mtr", hsn: "73089090", rate: "1937.42", discount: 0, taxableValue: 600600.00, cgstRate: 0, cgstAmount: 0, sgstRate: 0, sgstAmount: 0, igstRate: 18, igstAmount: 108108.00, total: 708708.00, batchNo: "B-9836", serialNo: "SN-025", weight: 780, warehouse: "Howrah Works W2", project: "IOCL Project", costCenter: "IES-SALES" }
      ],
      rawData: {
        buyer: {
          name: "B&R Vadodara",
      ...
      balance: "0.00",
      dateAsOn: "",
      balanceShortage: "708708.00",
      orderStatus: "CLOSED",
      disputeReason: null,
      createdAt: new Date()
    });

    this.salesInvoices.set("si4", {
      id: "si4",
      slNo: "01/26-27",
      poNumber: "4500097527",
      ...
      customerId: null,
      project: "Singrauli",
      amountIncGst: "-634250.00",
      duePayment: "634250.00",
      invoiceNo: "IES/26-27/04",
      invoiceDate: "2026-04-24",
      financialYear: "2026-2027",
      taxableAmount: "537500.00",
      totalGst: "96750.00",
      invoiceTotal: "634250.00",
      cgstAmount: "0.00",
      sgstAmount: "0.00",
      igstAmount: "96750.00",
      supplyType: "Interstate",
      irnNumber: "IRN-IES-2627-004",
      isEInvoice: true,
      status: "pending",
      lineItems: [
        { item: "Hot Dip Galvanised Cables Trays", qty: 150, unit: "Mtr", hsn: "73089090", rate: "3583.33", discount: 0, taxableValue: 537500.00, cgstRate: 0, cgstAmount: 0, sgstRate: 0, sgstAmount: 0, igstRate: 18, igstAmount: 96750.00, total: 634250.00, batchNo: "B-9837", serialNo: "SN-026", weight: 550, warehouse: "Kolkata Works W1", project: "Singrauli Project", costCenter: "IES-SALES" }
      ],
      rawData: {
        buyer: {
          name: "PES Eng. Pvt Ltd",
          gstin: "09AAACP9921D1ZO",
      ...
      balance: "634250.00",
      dateAsOn: "",
      balanceShortage: "634250.00",
      orderStatus: "RUNNING",
      disputeReason: null,
      createdAt: new Date()
    });

    this.salesInvoices.set("si5", {
      id: "si5",
      slNo: "35/25-26",
      ...
      customerId: null,
      project: "Hazira",
      amountIncGst: "-679975.00",
      duePayment: "679975.00",
      invoiceNo: "IES/26-27/08",
      invoiceDate: "2026-04-28",
      financialYear: "2026-2027",
      taxableAmount: "576250.00",
      totalGst: "103725.00",
      invoiceTotal: "679975.00",
      cgstAmount: "0.00",
      sgstAmount: "0.00",
      igstAmount: "103725.00",
      supplyType: "Interstate",
      irnNumber: "IRN-IES-2627-008",
      isEInvoice: true,
      status: "pending",
      lineItems: [
        { item: "Hot Dip Galvanised Cables Trays 300mm", qty: 200, unit: "Mtr", hsn: "73089090", rate: "2881.25", discount: 0, taxableValue: 576250.00, cgstRate: 0, cgstAmount: 0, sgstRate: 0, sgstAmount: 0, igstRate: 18, igstAmount: 103725.00, total: 679975.00, batchNo: "B-9838", serialNo: "SN-027", weight: 620, warehouse: "Kolkata Works W1", project: "Hazira Project", costCenter: "IES-SALES" }
      ],
      rawData: {
        buyer: {
          name: "AMNS",
          gstin: "24AAACA9824F1Z1",
          address: "AMNS Plant, Hazira, Gujarat - 394270",
          state: "Gujarat",
          state_code: "24"
        }
      },
