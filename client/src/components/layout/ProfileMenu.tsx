...
import { User, Settings, LogOut, CreditCard, LifeBuoy, ChevronRight, Shield, QrCode } from "lucide-react";
...
export function ProfileMenu() {
  ...
  return (
    <>
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-black uppercase tracking-widest text-blue-ink">Mobile Access</p>
                <p className="text-[8px] font-semibold text-blue-mid/50 mt-0.5">Connect phone to portal</p>
              </div>
              <ChevronRight size={12} className="text-blue-mid/25 flex-shrink-0" />
            </div>
          </DropdownMenuItem>
      ...
      <MobileAccessHelper open={showMobileModal} onOpenChange={setShowMobileModal} />
    </>
  );
}
